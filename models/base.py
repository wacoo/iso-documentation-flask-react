...
# engine = create_engine('mssql+pyodbc://localhost:1433/iso_db?driver=ODBC+Driver+18+for+SQL+Server')
...
# engine = create_engine('mssql+pyodbc://localhost\\SQL2019/iso_db?driver=ODBC+Driver+18+for+SQL+Server')
